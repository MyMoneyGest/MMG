// AirtelMoneyAllTransactionsScreen
...
type AirtelMoneyAllTransactionsAirtelProp = NativeStackNavigationProp<
  RootStackParamList,
  'AirtelMoneyAllTransactions'
>;
...
const AirtelMoneyAllTransactions = () => {
  ...
  const renderItem = ({ item }: { item: typeof transactions[0] }) => {
    ...
    const amountText = `${isReceived ? '+' : ''}${completeTransaction.amount} FCFA`;
