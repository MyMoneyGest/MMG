// AirtelMoneyEntrepriseScreen.tsx
...
type Props = NativeStackScreenProps<RootStackParamList, 'AirtelMoneyEntrepriseScreen'>;

const AirtelMoneyEntrepriseScreen: React.FC<Props> = ({ route, navigation }) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Airtel Money - Solde</Text>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigation.navigate('AirtelMoneyEntrepriseDetailsScreen', { companyId })}
      >
...
export default AirtelMoneyEntrepriseScreen;
